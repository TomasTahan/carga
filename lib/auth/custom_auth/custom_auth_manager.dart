...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    transportAIAuthUserSubject.add(
      TransportAIAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<TransportAIAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  TransportAIAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = TransportAIAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    transportAIAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
TransportAIAuthUser? currentUser;
